...
$results      = $wpdb->get_results( $wpdb->prepare( 'SELECT option_name FROM %s WHERE option_name LIKE %s OR option_name LIKE %s', $option_table, 'alg_wc_call_for_price%', 'alg_call_for_price%' ) ); // WPCS: db call ok, WPCS: cache ok.

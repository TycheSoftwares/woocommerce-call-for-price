...
const UPGRADE_URL = 'https://www.tychesoftwares.com/products/woocommerce-call-for-price-plugin/?utm_source=coslite&utm_medium=notice&utm_campaign=upgrade';
                ...
                <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span>
                            ...
                            {__('is only available in the Pro version.', 'woocommerce-call-for-price')}
                        </span>
                    </div>
...
export function ProInlineNotice({ feature, message, className = '' }) {
    const defaultMessage = feature
        ? sprintf( __('%s is only available in the Pro version.', 'woocommerce-call-for-price'), feature )
        : __('This option is only available in the Pro version.', 'woocommerce-call-for-price');

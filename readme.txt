...
7. User roleâ€“based Call for Price rules.
...
= 4.4.0 - 13/07/2026 =
* New â€“ React-based admin interface for General and Product Types pages.
* Dev â€“ Introduced a REST API layer (cfp-pro/v1) for plugin settings, product meta, migration, and license operations.
* Dev â€“ Consolidated settings storage from individual alg_wc_call_for_price_* options into cfp_pro_settings JSON object.
* Update â€“ Compatibility with WordPress 7.0.
* Update â€“ Compatibility with WooCommerce 10.9.4.

= 4.3.0 - 23/04/2026 =
* Fix - Security vulnerability where unsanitized textarea input could lead to XSS on the frontend.

= 4.2.0 - 03/02/2026 =
* Enhancement â€“ Added an option to display the â€œCall for Priceâ€ text for out-of-stock and backorder products.

...
=== Usage Tracking in Call For Price ===
...
* Plugin settings
* Settings for different product types
* Number of products for which product level settings are set up.
...
[Call For Price Usage Tracking](https://www.tychesoftwares.com/docs/woocommerce-call-for-price/call-for-price-usage-tracking/)
